...
export default function UsersSection() {
  ...
  const columns: Column<User>[] = [
    ...
    },
    {
      ...
      render: (user) => (
        <Badge
          variant={user.membershipCount >= 1 ? "default" : "outline"}
          className="text-xs"
        >
    ...
    <div className="space-y-6">
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center gap-1 text-xs text-amber-700 dark:text-amber-400">
                    ...
                    <span>
                      Invited {formatTimeAgo(invitation.createdAt)} by{" "}
                ...
                <Badge
                  variant="outline"
                  className="bg-amber-200/50 dark:bg-amber-800/50 text-amber-800 dark:text-amber-200 border-amber-300 dark:border-amber-700"
                >
                  Pending
                </Badge>
                <Button
      ...
      >
        <p className="text-foreground">
          ...
          This will also remove all their associated data (officer records,
          quotes, etc.).
        </p>
