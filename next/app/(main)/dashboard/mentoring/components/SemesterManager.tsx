    ...
    try {
      if (semester) {
        ...
        if (response.ok) {
          ...
          toast.success(
            newActiveState ? "Applications opened" : "Applications closed"
          );
        } else {
          ...
          {semester && (
            <div className="space-y-3">
                  ...
                  <div className="flex items-center gap-1">
                    <Button
                      ...
                      onClick={() => {
                        setIsEditing(false);
                        setEditOpen(
                          semester.applicationOpen?.split("T")[0] || ""
                        );
                        setEditClose(
                          semester.applicationClose?.split("T")[0] || ""
                        );
                      }}
                    >
                      <X className="h-3 w-3" />
              ...
              {isEditing ? (
                ...
                <p className="text-sm text-muted-foreground">
                  {formatDate(semester.applicationOpen)} —{" "}
                  {formatDate(semester.applicationClose)}
                </p>
              )}
            </div>
          )}
