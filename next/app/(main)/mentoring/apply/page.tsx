...
export default function MentorApplyPage() {
  ...
  const applyAutofill = () => {
    ...
    setPreviousSemesters(
      previousApplication.previousSemesters === 5
        ? "5+"
        : `${previousApplication.previousSemesters ?? 0}`
    );
    ...
    toast.success(
      "Autofilled from your previous application (availability cleared)."
    );
  };
    ...
    try {
      const response = await fetch("/api/mentor-application", {
        ...
        body: JSON.stringify({
          ...
          previousSemesters:
            previousSemesters === "5+" ? 5 : parseInt(previousSemesters),
          ...
          <Card>
            ...
            <CardContent className="text-center">
              <p className="text-muted-foreground mb-6">
                You need to be signed in to submit a mentor application. This
                allows us to link your application to your account.
              </p>
              <Button
                onClick={() =>
                  signIn("google", { callbackUrl: "/mentoring/apply" })
                }
              >
                Sign In to Apply
              </Button>
  ...
  const now = new Date();
  const isBeforeOpen =
    activeSemester.applicationOpen &&
    now < new Date(activeSemester.applicationOpen);
  const isAfterClose =
    activeSemester.applicationClose &&
    now > new Date(activeSemester.applicationClose);
          ...
          <Card>
            ...
            <CardContent className="text-center">
              <p className="text-muted-foreground">
                ...
                <strong>
                  {new Date(activeSemester.applicationOpen!).toLocaleDateString(
                    "en-US",
                    {
                      weekday: "long",
                      year: "numeric",
          ...
          <Card>
            ...
            <CardContent className="text-center space-y-4">
              <p className="text-muted-foreground">
                ...
                Check the mentor schedule or reach out to the mentoring head if
                you have questions.
              </p>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription className="space-y-4">
              <p className="break-words">
                Hello Potential Future Mentors! Thank you for your interest in
                becoming a Mentor. This is not a &quot;sign up&quot; form, but
                an interest form. Please fill out the information below to tell
                us about yourself, your skills, and why you want to become a
                mentor.
              </p>
              <p className="break-words">
              ...
              <div className="bg-muted p-3 rounded-md text-sm">
                ...
                <ul className="list-disc list-inside space-y-1 text-muted-foreground break-words">
                  ...
                  <li>
                    Mentors receive 24/7 swipe access to the SSE Lab (GOL-1670)
                  </li>
                  <li>End of semester dinner/gift from the SE department</li>
                  <li>We encourage you to have taken SWEN 261</li>
                  <li>
                    You do NOT need to be an SE major - all majors welcome!
                  </li>
                </ul>
              </div>
              {previousApplication && (
                <div className="flex flex-col gap-2 rounded-md border border-dashed border-border p-3">
                  <p className="text-sm text-muted-foreground">
                    Reapplying this semester? Autofill the form with your last
                    application.
                  </p>
                  <Button
                    type="button"
          ...
          <CardContent className="px-4 sm:px-6">
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-2">
                <Label>
                  Which of these courses have you taken previously or are taking
                  this semester? <span className="text-destructive">*</span>
                </Label>
              ...
              <div className="space-y-2">
                <Label htmlFor="skills">
                  Are there any other languages/technologies/skills that
                  you&apos;ve learned on a co-op/internship/hobby that
                  you&apos;d feel comfortable assisting with?{" "}
                  <span className="text-destructive">*</span>
                </Label>
                <Textarea
                  id="skills"
              ...
              <div className="space-y-2">
                <Label htmlFor="whyMentor">
                  Why are you interested in being a mentor, and why do you think
                  you would make a good mentor?{" "}
                  <span className="text-destructive">*</span>
                </Label>
                <Textarea
                  id="whyMentor"
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-muted-foreground">
                  Select all time slots when you could be available to help in
                  the SSE lab. This helps us create a schedule that works for
                  everyone.
                </p>
