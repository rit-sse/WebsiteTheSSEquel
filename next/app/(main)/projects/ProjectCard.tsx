  ...
  return (
    <div className="w-full">
      ...
      >
        ...
        <div
          className="absolute bottom-0 w-full min-h-[48px] max-h-[80px] bg-black/40 backdrop-blur-md
                        p-3 flex items-center"
        >
          <p className="text-white text-base font-bold font-display line-clamp-2">
            {project.title}
          </p>
        </div>
      </Card>
