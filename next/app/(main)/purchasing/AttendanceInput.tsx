...
export default function AttendanceInput({
  ...
  const handleParse = () => {
    ...
    if (parsed.length === 0) {
      setParseError(
        "Could not parse any attendees from the pasted data. Try format: First Name, Last Name, Email"
      );
      return;
    }
    ...
    <div className="space-y-4">
      ...
      <Tabs defaultValue="manual" className="w-full">
        ...
        <TabsContent value="paste" className="space-y-4 mt-4">
          <p className="text-sm text-muted-foreground">
            Paste data from a spreadsheet. Format: First Name, Last Name, Email
            (one per line)
          </p>
