    ...
    return (
      <>
        ...
        >
            ...
            {editableQuotes.map((entry, index) => (
              ...
              >
                <div className="space-y-1">
                  <Label htmlFor={`edit-quote-${quote.id}-${index}`}>
                    Quote
                  </Label>
                  <Input
                    ...
                    value={entry.quote}
                    onChange={(e) =>
                      updateEditableQuoteField(index, "quote", e.target.value)
                    }
                  />
                </div>
                <div className="space-y-1">
                  <Label htmlFor={`edit-author-${quote.id}-${index}`}>
                    Author
                  </Label>
                  <Input
                    ...
                    value={entry.author}
                    onChange={(e) =>
                      updateEditableQuoteField(index, "author", e.target.value)
                    }
                  />
                </div>
          ...
          <ModalFooter>
            <Button variant="neutral" onClick={() => setEditOpen(false)}>
              Cancel
            </Button>
