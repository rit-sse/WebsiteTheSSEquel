...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    return new Response(JSON.stringify({ error: "Failed to fetch copies" }), {
      status: 500,
    });
  }
}
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    return new Response(JSON.stringify({ error: "Failed to create copy" }), {
      status: 500,
    });
  }
}
...
export async function PUT(request: NextRequest) {
  ...
  try {
    ...
    return new Response(JSON.stringify({ error: "Failed to update copy" }), {
      status: 500,
    });
  }
}
