        ...
        <div >
            {
                ...
                <div className="fixed top-[0px] left-[0px] w-[100%] h-[100%] z-[100]
                    ...
                    <div className="relative w-[400px] h-[650px] z-[50] bg-background rounded-lg overflow-hidden
                            ...
                            <div className="flex h-[90%] w-[100%] items-center justify-center relative
                                ...
                                <div className="relative h-full w-full overflow-hidden rounded-l">
                                    ...
                                    <Image 
                                        ...
                                        unoptimized
                                    />
                                    <div className="absolute top-0 left-0 w-[100%] h-[100%] backdrop-blur-[15px] bg-black/25 rounded-l z-10"> </div>
                                    <Image 
                                        src={projectBackground} 
                                        alt={project.title}
                                        fill
                                        className="object-contain z-20 rounded-l"
                                        unoptimized
                                    />
                                </div>
                                    {/*  Text Container */}
