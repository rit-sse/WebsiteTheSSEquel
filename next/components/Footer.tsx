...
import StyleModeToggle from "./common/StyleModeToggle";
import FontModeToggle from "./common/FontModeToggle";

const Footer: React.FC = () => {
    return (
        <footer className="flex items-center justify-between w-full h-auto p-3">
            <div className="flex items-center justify-start gap-1 fixed left-3 bottom-3">
                <DarkModeToggle />
                <StyleModeToggle />
                <FontModeToggle />
            </div>
