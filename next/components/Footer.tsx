    ...
    <footer className="flex items-center w-full h-auto p-3">
      ...
      <div className="flex flex-row items-center gap-2 ml-auto">
        ...
        <Link
          ...
          className="inline-flex h-9 w-9 items-center justify-center rounded-md text-foreground hover:text-foreground/80 transition-colors"
        ...
        <Link
          href="https://www.linkedin.com/company/society-of-software-engineers/"
          className="inline-flex h-9 w-9 items-center justify-center rounded-md text-foreground hover:text-foreground/80 transition-colors"
        ...
        <Link
          href={HomepageContent.twitchLink}
          className="inline-flex h-9 w-9 items-center justify-center rounded-md text-foreground hover:text-foreground/80 transition-colors"
        ...
        >
          <span className="h-5 w-5 overflow-hidden">
            <TwitchIcon className="h-full w-full" />
          </span>
        </Link>
        <Link
          href="https://github.com/rit-sse"
          className="inline-flex h-9 w-9 items-center justify-center rounded-md text-foreground hover:text-foreground/80 transition-colors"
