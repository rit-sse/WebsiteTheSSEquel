...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(
        "flex h-10 w-full items-center justify-between bg-secondary-background shadow-sm gap-2 px-3 py-2 text-sm font-base text-foreground ring-offset-background placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:cursor-not-allowed disabled:bg-interactive-disabled/25 disabled:text-text-subtle [&>span]:line-clamp-1 *:data-[slot=select-value]:line-clamp-1 *:data-[slot=select-value]:flex *:data-[slot=select-value]:items-center *:data-[slot=select-value]:gap-2 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
        // Neo mode: thick border
        "neo:rounded-base neo:border-2 neo:border-border/50",
        // Clean mode: thin border, softer corners
        "clean:rounded-md clean:border clean:border-border/30",
        className,
      )}
      {...props}
    >
    ...
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        ...
        className={cn(
          ...
          // Neo mode: thick border
          "neo:rounded-base neo:border-2 neo:border-border/50",
          // Clean mode: thin border, softer corners, shadow
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        ...
        "neo:rounded-base neo:border-2 neo:border-transparent neo:focus:border-border/50",
